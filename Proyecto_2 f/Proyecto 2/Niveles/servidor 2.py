...
servidor = "192.168.100.25"  # le asigna a la variable servidor una cadena de caracteres conteniendo la direccioxcn ipv4 del computador que sera servidor
puerto = 49887  # le asigna a la variable puerto un entero (55531)
servidorLocal = socket.socket(socket.AF_INET,socket.SOCK_STREAM)  # socket.socket recibe como parametros el socket.AF.NET
