...
class Network: #defino la clase conexiones
    def __init__(self) : # defino el constructor de la clase sin parametros
        ...
        self.servidor = "192.168.10.101"  # define la red o donde iniciara el servidor
    ...
    def getposicion(self):# define la funcion getposicion
        return self.posicion # returna self.posicion
